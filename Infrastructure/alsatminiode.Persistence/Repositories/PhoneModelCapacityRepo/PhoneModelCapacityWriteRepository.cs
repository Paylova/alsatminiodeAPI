...
{
    public class PhoneModelCapacityWriteRepository : WriteRepository<PhoneModelCapacity>, IPhoneModelCapacityWriteRepository
    {
        public PhoneModelCapacityWriteRepository(alsatminiodeAPIDbContext context) : base(context)
        {
        }
    }
}
