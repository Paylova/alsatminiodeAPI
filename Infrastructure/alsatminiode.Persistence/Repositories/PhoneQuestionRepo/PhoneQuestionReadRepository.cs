...
{
    public class PhoneQuestionReadRepository : ReadRepository<PhoneQuestion>, IPhoneQuestionReadRepository
    {
        public PhoneQuestionReadRepository(alsatminiodeAPIDbContext context) : base(context)
        {
        }
    }
}
